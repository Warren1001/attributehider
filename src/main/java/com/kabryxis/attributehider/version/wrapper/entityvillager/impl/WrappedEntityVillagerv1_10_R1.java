...
import com.kabryxis.attributehider.version.wrapper.merchantrecipelist.impl.WrappedMerchantRecipeListv1_10_R1;

import net.minecraft.server.v1_10_R1.EntityVillager;
import net.minecraft.server.v1_10_R1.NBTTagCompound;

public class WrappedEntityVillagerv1_10_R1 extends WrappedEntityVillager<EntityVillager> {
	...
	public void setOffers(WrappedMerchantRecipeList<?> list) {
		...
		object.b(tag);
		tag.set("Offers", ((WrappedMerchantRecipeListv1_10_R1)list).get().a());
		object.a(tag);
	}
