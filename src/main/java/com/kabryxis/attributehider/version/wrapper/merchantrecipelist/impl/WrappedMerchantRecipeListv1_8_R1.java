...
import com.kabryxis.attributehider.version.wrapper.merchantrecipe.impl.WrappedMerchantRecipev1_8_R1;
...
public class WrappedMerchantRecipeListv1_8_R1 extends WrappedMerchantRecipeList<MerchantRecipeList> {
	...
	public List<WrappedMerchantRecipe<?>> getRecipes() {
		...
		for(Object obj : object) {
			...
			WrappedMerchantRecipev1_8_R1 handle = (WrappedMerchantRecipev1_8_R1)WrapperCache.get(WrappedMerchantRecipe.class);
			handle.set(recipe);
			list.add(handle);
		}
		return list;
	...
	public void setRecipes(List<WrappedMerchantRecipe<?>> recipes) {
		object.clear();
		recipes.forEach(r -> object.add(r.getHandle()));
	}
