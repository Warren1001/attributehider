...
import com.kabryxis.attributehider.version.wrapper.merchantrecipe.impl.WrappedMerchantRecipev1_8_R2;
...
public class WrappedMerchantRecipeListv1_8_R2 extends WrappedMerchantRecipeList<MerchantRecipeList> {
	...
	public void setRecipes(List<WrappedMerchantRecipe<?>> recipes) {
		object.clear();
		recipes.forEach(r -> object.add(((WrappedMerchantRecipev1_8_R2)r).get()));
	}
