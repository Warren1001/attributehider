...
import com.kabryxis.attributehider.version.wrapper.merchantrecipelist.impl.WrappedMerchantRecipeListv1_9_R1;
...
public class WrappedEntityVillagerv1_9_R1 extends WrappedEntityVillager<EntityVillager> {
	...
	public WrappedMerchantRecipeListv1_9_R1 getOffers() {
		WrappedMerchantRecipeListv1_9_R1 handle = (WrappedMerchantRecipeListv1_9_R1)WrapperCache.get(WrappedMerchantRecipeList.class);
	...
	public void setOffers(WrappedMerchantRecipeList<?> list) {
		...
		object.b(tag);
		tag.set("Offers", ((WrappedMerchantRecipeListv1_9_R1)list).get().a());
		object.a(tag);
	}
